...
function partitionJavaScript(source,file,root){
	...
	var result = [],latestType=-1;//not comment string regexp
	return _partitionJavaScript(source,file,root,result,append);
}
function _partitionJavaScript(source,file,root,result,append){
