...
exports.cmd= function cmd(args){
	...
	if(cmd == 'install'){
		...
		if(isHelp){
			...
			exports.export4web('./',args,function(impls,internalDeps,externalDeps){
				if(externalDeps.length >0){
					...
					var source = exports.buildExportSource("'./'",impls,ns,args.length);
					fs.writeFile(out,require('../lib/js-token').compressJS(source),function(err){
