 ...
 * 
 * @author jindw
 * @version $Id: boot-core.js,v 1.17 2008/03/15 14:05:09 jindw Exp $
 */
...
//    }
     ...
     */
     function loadScript(packageObject,fileName,object){
        ...
        if(!loader){
            $log.trace("load script path:",packageObject.scriptBase ,fileName);
        ...
        if(loader.initialize){
            $log.trace("object loader initialize:",packageObject.scriptBase ,fileName);
