<%@ page contentType="text/html; charset=utf-8" pageEncoding="utf-8"
 isELIgnored="false"%>/**${param['path'] ==null?'':'/'}$JSI.preload("${param['path']}".replace(/\/[^/]*$/,'').replace(/\//g,'.'),"${param['path']}".replace(/^.*\//,''),function(){eval(this.varText);<jsp:include
