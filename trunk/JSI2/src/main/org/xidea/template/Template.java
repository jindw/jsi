...
public class Template {
		...
		for (final Object item : children) {
			try {
				if (item instanceof String) {
					...
					case EL_TYPE:// ":el":
						renderExpression(context, data, out, false);
						break;
					case EL_TYPE_XML_TEXT:// ":el":
						renderExpression(context, data, out, true);
						break;
					case VAR_TYPE:// ":set"://var
						renderVar(context, data);
						break;
					case IF_TYPE:// ":if":
						renderIf(context, data, out);
						break;
					case ELSE_TYPE:// ":else-if":":else":
						renderElse(context, data, out);
						break;
					case FOR_TYPE:// ":for":
						renderFor(context, data, out);
						break;
	...
	@SuppressWarnings("unchecked")
	protected void renderExpression(Map context, Object[] data, Writer out,
	...
	@SuppressWarnings("unchecked")
	protected void renderIf(Map context, Object[] data, Writer out) {
		boolean test;
		try {
	...
	@SuppressWarnings("unchecked")
	protected void renderElse(Map context, Object[] data, Writer out) {
	...
	@SuppressWarnings("unchecked")
	protected void renderFor(Map context, Object[] data, Writer out) {
	...
	@SuppressWarnings("unchecked")
	protected void renderVar(Map context, Object[] data) {
	...
	@SuppressWarnings("unchecked")
	protected void renderAttribute(Map context, Object[] data, Writer out)
			throws IOException {
		if (data[2] != null) {
