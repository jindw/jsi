...
public class DefaultEntityResolver implements EntityResolver2 {
	...
	static{
		DEFAULT_DTD_MAP.put("-//W3C//DTD XHTML 1.0 Transitional//EN", "xhtml1-transitional.dtd");
	...
	public InputSource resolveEntity(String publicId,
		...
		InputSource source = new InputSource(this.getClass().getResourceAsStream(path));
