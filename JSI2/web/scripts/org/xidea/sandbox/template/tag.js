 ...
 * @author jindw
 * @version $Id: tag.js,v 1.2 2008/02/24 05:57:41 jindw Exp $
 */
 ...
 * @protected
 */
DefaultTag.prototype[1] = function(context,node){
    context.printIndent();
    context.put('<'+node.tagName);
...
CoreTag.prototype.include = function(context,node){
    try{
        ...
        if(path == null){
            ...
            var doc = new Template(path).doc;//BUG document base....
        }
        if(xpath != null){
            if(doc.selectNodes){
