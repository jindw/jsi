 ...
 *
 * @see sun.org.mozilla.javascript.internal.Parser
 *
 * @author Mike McCabe
 * @author Brendan Eich
 */
...
class TokenStream2
{
    ...
    TokenStream2(Parser parser, Reader sourceReader, String sourceString,
                int lineno)
    {
        this.parser = parser;
        this.lineno = lineno;
...
// The following assumes that Token.EOF == 0
        final int
            ...
            Id_const         = -1,//Token.CONST,//TODO:jindw changed
